...
function App() {
  return (
    <div className="App" align="center" id="container">
      <h1>Política de Privacidade - CryptoApp</h1>
      <p align="justify">A sua privacidade é importante para nós. É política do CryptoApp respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site CryptoApp, e outros sites que possuímos e operamos.
...
<p align="justify">O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o CryptoApp oferece no site e com caráter enunciativo, mas não limitativo: </p>
<ul align="justify">
...
<li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do CryptoApp, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
</ul>
<h2>Compromisso do Usuário</h2>
